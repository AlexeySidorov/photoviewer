...
namespace photoviewer.Droid.Infrastructure.Services
{
    public class PlatformService : IPlatformService
    {
        ...
        public static Date DateTimeToNativeDate(DateTime date)
        {
        ...
        public static Date ConvertTimeZone(Date date, Java.Util.TimeZone fromTZ, Java.Util.TimeZone toTZ)
        {
            long fromTZDst = 0;
            ...
            return new Date(date.Time + (toTZOffset - fromTZOffset));
        }
